...
#include "miryoku_layer_alternatives.h"
      ...
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_BEPO_FLIP
    ...
    #elif defined (MIRYOKU_ALPHAS_BEPO)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_BEPO
    #elif defined (MIRYOKU_ALPHAS_BEAKL15)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_ALPHAS_BEPO)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_BEPO_FLIP
    ...
    #elif defined (MIRYOKU_ALPHAS_BEPO)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_BEPO
    #elif defined (MIRYOKU_EXTRA_BEAKL15)
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_TAP_BEPO)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_BEPO_FLIP
    ...
    #elif defined (MIRYOKU_TAP_BEPO)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_BEPO
    #elif defined (MIRYOKU_TAP_BEAKL15)
