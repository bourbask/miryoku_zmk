...
&kp B,             &kp É,             &kp P,             &kp O,             &kp È,             &kp DOT,           &kp V,             &kp D,             &kp L,             &kp J,             \
U_MT(LGUI, A),     U_MT(LALT, U),     U_MT(LCTRL, I),    U_MT(LSHFT, E),    &kp COMMA,         &kp C,             U_MT(LSHFT, T),    U_MT(LCTRL, S),    U_MT(LALT, R),     U_MT(LGUI, N),     \
U_LT(U_BUTTON, Ê), U_MT(RALT, À),     &kp Y,             &kp X,             &kp K,             &kp SQT,           &kp Q,             &kp G,             U_MT(RALT, H),     U_LT(U_BUTTON, F), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
&kp Ê,             &kp À,             &kp Y,             &kp X,             &kp K,             &kp SQT,           &kp Q,             &kp G,             &kp H,             &kp F,             \
U_NP,              U_NP,              &kp DEL,           &kp BSPC,          &kp RET,           &kp TAB,           &kp SPACE,         &kp ESC,           U_NP,              U_NP
